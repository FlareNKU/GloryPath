...
2. 将文档放于[`docs`](https://github.com/FlareNKU/GloryPath/tree/main/docs)下对应文件夹，其他文件放于[`files`](https://github.com/FlareNKU/GloryPath/tree/main/docs/files)中，然后pull request
